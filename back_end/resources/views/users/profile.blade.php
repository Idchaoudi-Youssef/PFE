        ...
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <div class="user-profile">
                    <h3 class="mb-3 theme-color">Profil Utilisateur</h3>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <p>{{ $user->utype == 'USR' ? 'Utilisateur' : 'Admin' }}</p>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <p>{{ $user->country }}</p> <!-- À adapter selon la logique de votre application -->
                        </div>
                    ...
                    <a href="{{ route('User.EditUser', $user->id) }}" class="btn btn-solid-default mt-4">Éditer le Profil</a>
